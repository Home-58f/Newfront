...
const MainAppContent = () => {
  ...
  const AuthPage = () => {
    ...
    return (
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1542841961-d64e9a3b839b?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
        }}
      >
    ...
    return (
      <div className="p-6">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-8">
          AgriHub is a next-generation e-commerce platform designed exclusively
          for the farming community. Our mission is to empower farmers by
          providing a digital marketplace where they can easily list, promote,
          and sell their products directly to consumers, retailers, and
          businesses—eliminating intermediaries and maximizing profits.
        </p>

        {/* What Makes Agrihub Unique Section */}
        <h3 className="text-2xl font-bold text-amber-800 mb-6">
          What Makes AgriHub Unique?
        </h3>
        <div className="grid md:grid-cols-2 gap-8 mt-6">
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            <img
              ...
              onError={(e) => {
                ...
                e.target.src = `https://placehold.co/400x250/d4edda/2a5c3a?text=Direct-to-Market`;
              }}
            />
            <div className="p-4">
              <h4 className="text-xl font-semibold text-amber-900 mb-2 flex items-center">
                <ShoppingBag className="mr-2" /> Direct-to-Market Sales
              </h4>
              <p className="text-gray-600 text-sm">
                Sell produce, dairy, grains, meat, and value-added goods
                directly.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src = `https://placehold.co/400x250/d4edda/2a5c3a?text=Farm+Services`;
              }}
            />
            <div className="p-4">
              <h4 className="text-xl font-semibold text-amber-900 mb-2 flex items-center">
                <Tractor className="mr-2" /> Integrated Farm Services
              </h4>
              <p className="text-gray-600 text-sm">
                Offer rentals, soil testing, crop spraying, and on-farm
                experiences.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src = `https://placehold.co/400x250/d4edda/2a5c3a?text=Smart+Tools`;
              }}
            />
            <div className="p-4">
              <h4 className="text-xl font-semibold text-amber-900 mb-2 flex items-center">
                <BarChart className="mr-2" /> Smart Tools for Farmers
              </h4>
              <p className="text-gray-600 text-sm">
                Inventory, analytics, and compliance support for optimized
                operations.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src = `https://placehold.co/400x250/d4edda/2a5c3a?text=Community+%26+Learning`;
              }}
            />
            <div className="p-4">
              <h4 className="text-xl font-semibold text-amber-900 mb-2 flex items-center">
                <Users className="mr-2" /> Community and Learning
              </h4>
              <p className="text-gray-600 text-sm">
                Host/join events, access knowledge hub, and farmer-to-farmer
                exchange.
              </p>
            </div>
          </div>
        ...
        <h3 className="text-2xl font-bold text-amber-800 mt-10 mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-6">
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            ...
            <div className="p-4 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Filter by location, farming method, or product type.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            ...
            <div className="p-4 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Flexible payments, secure checkout, transparent delivery.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            ...
            <div className="p-4 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Ratings and reviews system fosters trust.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-amber-50 p-6 rounded-lg shadow-sm border border-amber-100 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">
              Set up recurring deliveries for loyal customers (weekly,
              bi-weekly, monthly).
            </p>
          </div>
          ...
          <div className="bg-amber-50 p-6 rounded-lg shadow-sm border border-amber-100 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">
              List and book specialized farm services or equipment rentals
              directly.
            </p>
          </div>
          {/* Event Booking */}
          <div className="bg-amber-50 p-6 rounded-lg shadow-sm border border-amber-100 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">
              Promote farm tours, workshops, or seasonal festivals directly to
              consumers.
            </p>
          </div>
          ...
          <div className="bg-amber-50 p-6 rounded-lg shadow-sm border border-amber-100 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">
              Facilitate large orders for restaurants, stores, or food hubs with
              dedicated tools.
            </p>
          </div>
          ...
          <div className="bg-amber-50 p-6 rounded-lg shadow-sm border border-amber-100 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">
              Showcase your eco-friendly practices and certifications to attract
              conscious buyers.
            </p>
          </div>
        </div>
  ...
  const ProductsPage = ({ selectedCategoryId }) => {
    ...
    const handleProductSubmit = async (isEditMode) => {
      ...
      try {
        ...
        if (!updatedProductsResponse.ok)
          throw new Error("Failed to re-fetch products.");
    ...
    const filteredAndSearchedProducts = products.filter(
      (product) =>
    ...
    return (
      <div className="p-6">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          Discover a wide range of fresh produce, dairy, grains, meats, and
          unique value-added goods directly from local farmers. Whether you're
          looking for weekly staples or specialty items, AgriHub connects you to
        ...
        {isLoading ? (
          ...
          <p className="text-center text-gray-600 py-10">
            No products found matching your criteria. Be the first to add one!
          </p>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                >
                  <img
                    src={
                      product.image_url ||
                      `https://placehold.co/400x200/e0ffe0/333333?text=${
                    ...
                    onError={(e) => {
                      e.target.onerror = null;
                      e.target.src = `https://placehold.co/400x200/e0ffe0/333333?text=${
                        product.name || "Product"
                      }`;
                    }}
                  />
                  <div className="p-4">
                    ...
                    <p className="text-gray-500 text-xs">
                      Farmer: {product.farmer_username}
                    </p>
                    <p
                ...
                <div className="p-4 border-t border-gray-100 flex justify-between items-center">
                  ...
                  {(user?.role === "farmer" && product.farmer_id === user.id) ||
                  user?.role === "admin" ? (
  ...
  const ProductDetailPage = ({ productId }) => {
    ...
    if (error) {
      return (
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-md text-sm mb-4 text-center">
          ...
          <button
            onClick={() => navigate("products")}
            className="mt-4 px-4 py-2 bg-amber-700 text-white rounded-md hover:bg-amber-800"
          >
            Back to Products
          </button>
        </div>
    ...
    return (
      <div className="p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
        <button
          onClick={() => navigate("products")}
          className="mb-6 text-amber-800 hover:text-amber-900 flex items-center"
        >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="flex justify-center items-center bg-gray-50 rounded-lg overflow-hidden">
            <img
              src={
                product.image_url ||
                `https://placehold.co/600x400/e0ffe0/333333?text=${
                  product.name || "Product"
                }`
              }
              alt={product.name}
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src = `https://placehold.co/600x400/e0ffe0/333333?text=${
                  product.name || "Product"
                }`;
              }}
            />
          ...
          <div>
            ...
            <p className="text-amber-800 font-bold text-3xl mb-4">
              ${product.price} / {product.unit}
            </p>
            ...
            <p className="text-gray-600 text-sm mb-4">
              Farmer:{" "}
              <span className="font-semibold">{product.farmer_username}</span>
            </p>
            <p className="text-sm font-semibold mb-6">
              <span
                className={
                  product.stock_quantity > 0 ? "text-lime-700" : "text-red-600"
                }
              >
                Stock:{" "}
                {product.stock_quantity > 0
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="bg-white p-4 rounded-lg shadow-sm flex items-center space-x-4 border border-gray-200"
              >
                <img
                  src={
                    item.image_url ||
                    `https://placehold.co/100x100/e0ffe0/333333?text=Product`
                  }
                  alt={item.name}
    ...
    if (orderSuccess) {
      return (
        <div className="p-6 text-center bg-white rounded-lg shadow-lg max-w-xl mx-auto my-8">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for shopping with AgriHub!
          </p>
          <button
            onClick={() => navigate("dashboard")}
            className="bg-amber-700 hover:bg-amber-800 text-white font-bold py-2 px-4 rounded-md shadow-md transition-colors duration-300"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <form onSubmit={handlePlaceOrder} className="space-y-4">
            ...
            >
              {isLoading ? (
                <>
                  <Loader2 className="animate-spin mr-2" size={20} /> Placing
                  Order...
                </>
              ) : (
                <>
      ...
      const fetchData = async () => {
        ...
        try {
          ...
          const ordersEndpoint =
            user.role === "customer" ? "/orders/myorders" : "/orders";
          ...
          if (user.role === "farmer" || user.role === "admin") {
            ...
            if (!productsResponse.ok)
              throw new Error("Failed to fetch managed products");
          ...
          <>
            ...
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-md text-yellow-800">
              ...
              <p className="text-sm mt-1">
                This ID identifies your account and associated data on AgriHub.
              </p>
            </div>
                  ...
                  <div className="space-y-4">
                    {orders.map((order) => (
                      ...
                      >
                        ...
                        <h5 className="font-semibold text-gray-700 mt-3 mb-2">
                          Items:
                        </h5>
            ...
            {(user.role === "farmer" || user.role === "admin") && (
              <div className="mt-8">
                <h3 className="text-2xl font-semibold text-amber-800 mb-4">
                  Your Managed Products ({productsManaged.length})
                </h3>
                {productsManaged.length === 0 ? (
                  <p className="text-gray-600">
                    You haven't listed any products yet. Go to the Products page
                                ...
                                try {
                                  ...
                                  const updatedOrdersResponse = await fetch(
                                    `${API_BASE_URL}/orders`,
                                    {
                                      headers: {
                                        "Content-Type": "application/json",
                                        // add any other headers needed here, e.g. Authorization
                                      },
                                    }
                                  );
                                  if (!updatedOrdersResponse.ok)
                                    throw new Error(
                                      "Failed to re-fetch orders."
                                    );
                                  const updatedOrdersData =
                                    await updatedOrdersResponse.json();
  ...
  const ServicesPage = () => {
    ...
    useEffect(() => {
      ...
      const dummyServices = [
        {
          id: "s1",
          name: "Tractor Rental (Hourly)",
          description:
            "High-power tractor with operator for field preparation.",
          price: "75.00",
          providerId: "mockfarmer1",
        ...
        },
        {
          ...
          description:
            "Comprehensive soil nutrient analysis with recommendations.",
          price: "120.00",
          providerId: "mockfarmer2",
        ...
        },
        {
          ...
          description:
            "Professional pest and disease control for various crops.",
          price: "200.00",
          providerId: "mockfarmer1",
    ...
    return (
      <div className="p-6">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          Beyond products, AgriHub offers a comprehensive marketplace for
          farm-related services. Farmers can list and book essential services
          like equipment rentals, specialized agricultural support, or even
          offer unique on-farm experiences to connect with the community.
        </p>
        {user?.role === "farmer" || user?.role === "admin" ? (
          <button
        ...
        {isLoading ? (
          ...
          <p className="text-gray-600">
            No services listed yet. Farmers, offer your expertise!
          </p>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service) => (
              ...
              >
                ...
                <p className="text-gray-500 text-xs mt-2">
                  Provided by: {service.providerId?.substring(0, 8)}...
                </p>
              </div>
            ))}
          </div>
  ...
  const EventsPage = () => {
      ...
      const dummyEvents = [
        {
          ...
          description:
            "Learn best practices for spring planting and soil health.",
          date: "2025-04-15",
        },
        {
          id: "e2",
          name: "Farm-to-Table Dinner Gala",
          description:
            "Enjoy a multi-course meal prepared with local, seasonal ingredients.",
          date: "2025-05-20",
        },
        {
          id: "e3",
          ...
          description:
            "Explore innovations in eco-friendly agriculture and connect with experts.",
          date: "2025-06-10",
        },
      ];
    ...
    return (
      <div className="p-6">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          Join the AgriHub community at various virtual or in-person events.
          From seasonal festivals and cooking demonstrations to sustainable
          farming workshops and farmer meetups, there's always something new to
            ...
            {events.map((event) => (
              ...
              >
                ...
                <p className="text-gray-500 text-xs flex items-center">
                  <MapPin size={16} className="mr-1" /> Date: {event.date}
                </p>
              </div>
            ))}
          </div>
